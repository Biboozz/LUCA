...
public class ListBox {
	...
	{
		int itemIndex = listItems.Count+1;
		listItems.Add(new ListItem(itemIndex, new Rect(0, 0,(int)visibleRect.width, 17), c_ItemIcon));
		return itemIndex;
	}
	...
	{
		int itemIndex = listItems.Count+1;
		listItems.Insert(insertPos, new ListItem(itemIndex, new Rect(0, 0,(int)visibleRect.width, 17), c_ItemIcon));
		return itemIndex;
	}
